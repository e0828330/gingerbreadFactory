...
public class Main {
	...
	public static void main(String[] args) {
		...
		Thread supplier3;
			...
			Supplier jmsSupplier1 = new JMSSupplierInstance(JMSUtils.parseFactoryID(args, 0));
			...
			Supplier jmsSupplier2 = new JMSSupplierInstance(JMSUtils.parseFactoryID(args, 0));
			...
			Supplier jmsSupplier3 = new JMSSupplierInstance(JMSUtils.parseFactoryID(args, 0));
			jmsSupplier3.setId(3L);
			jmsSupplier3.placeOrder(7, Ingredient.Type.FLOUR);
			supplier3 = new Thread(jmsSupplier3);
			supplier3.start();	
			
			Supplier jmsSupplier4 = new JMSSupplierInstance(JMSUtils.parseFactoryID(args, 0));
			jmsSupplier4.setId(4L);
			jmsSupplier4.placeOrder(2, Ingredient.Type.NUT);
			supplier3 = new Thread(jmsSupplier4);
			supplier3.start();	
			
			Supplier jmsSupplier5 = new JMSSupplierInstance(JMSUtils.parseFactoryID(args, 0));
